  ...
  return (
    <div className='min-h-screen w-full'>
      <div className='relative h-3/5 w-full'>
        <Image src={image} alt=''  className='brightness-40 h-screen w-full object-cover' />
      ...
      <div className='relative z-20 -mt12 h-full w-full flex flex-col items-center '>
        <form action="" className='border w-2/3 h-28 border-slate-500 px-4 py-12 rounded-xl bg-blue-600 text-white flex justify-between items-center '>
          <div className='flex flex-col items-start gap-1'>
            ...
            <Select data={optionLocations} className="text-white p-2 rounded-xl outline-none capitalize" />
          </div>
          <div className='flex flex-col items-start gap-1'>
            <h3 className='ml-1 text-[#efefef] font-semibold'>
                Price
            ...
            <div className='flex items-center gap-2'>
              <Input type="number" placeholder="Min. price" className="text-white p-2 rounded-xl outline-none" />
              <Input type="number" placeholder="Max. price" className="text-white p-2 rounded-xl outline-none" />
            </div>
          ...
          <div className='flex flex-col items-start gap-1'>
            ...
            <Select data={optionTypes} className="text-white p-2 rounded-xl outline-none"/>
          </div>
          {/* <B */}
        </form>
